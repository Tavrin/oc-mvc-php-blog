...
class MediaForm extends Form
{
    public function __construct(Request $request, object $entity, Session $session, array $options = [])
    {
        ...
        $this->addTextInput('name', ['class' => 'form-control js-binder', 'placeholder' => "Nom du média", 'label' => 'Nom','dataAttributes' => ['type' => 'text', 'target' => 'slug', 'target-attribute' => 'value', 'options' => ['slugify' => true]], 'value' => 'edit' === $options['type']? $entity->getName() : null])
            ...
            ->addDateTimeInput('createdAt', ['class' => 'form-control', 'placeholder' => "Date de création", 'readonly' => true, 'value' => 'edit' === $options['type']? $entity->getCreatedAt()->format("Y-m-d\TH:i:s") : null])
            ->addDateTimeInput('updatedAt', ['class' => 'form-control', 'placeholder' => "Date de modification", 'readonly' => true, 'value' => 'edit' === $options['type']? $entity->getUpdatedAt()->format("Y-m-d\TH:i:s") : null])
            ...
            ->addFileInput('mediaFile',['class' => 'form-control mt-1 mb-1 js-binder', 'dataAttributes' => ['type' => 'image', 'from' => 'file', 'target' => 'previewImage'], 'label' => 'Media', 'required' => false,'entity' => false, 'accept' => 'image/*', 'whitelist' => ['mimes' => 'WHITELIST_IMAGE', 'type' => 'enum']])
